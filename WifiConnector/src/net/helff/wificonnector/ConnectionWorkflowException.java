...
public class ConnectionWorkflowException extends Exception {
     ...
     * 
     */
    private static final long serialVersionUID = -8268206704577894091L;

    public ConnectionWorkflowException(String message) {
        super(message);
    }
    
    public ConnectionWorkflowException(String message, Throwable e) {
        super(message, e);
    }
}
